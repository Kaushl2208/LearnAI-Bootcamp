...
Finally, before arriving at the workshop, we expect you to have completed [1_Setup](https://github.com/Azure/LearnAI-Bootcamp/blob/master/lab01.1-computer_vision/1_Setup.md).
